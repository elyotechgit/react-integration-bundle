<?php
namespace React\IntegrationBundle\Twig\Extension;

use Symfony\Component\DependencyInjection\ContainerInterface;

class ReactIntegrationExtension extends \Twig_Extension
{
    /**
     * Container
     *
    ...
    {
        return array(
            'react_init' => new \Twig_Function_Method($this, 'react_init', array('is_safe' => array('html')))
        );
    }
...
//        $config['jquery_script_url'] = $assets->getUrl($baseURL.'bundles/reactintegration/vendor/tiny_mce/tiny_mce.jquery.js');
//
...
//        }
        ...
        return $this->getService('templating')->render('ReactIntegrationBundle:Script:init.html.twig', array(
